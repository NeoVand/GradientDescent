...
const RAW_STEPS: RawStep[] = [
  ...
  { sel: 'run-race', title: 'Race optimizers', body: 'Opens the race setup — pick the optimizers, tune them, then launch them from the same point to see who reaches the basin first.', side: 'right', align: 'center' },
